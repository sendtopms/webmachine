...
loop(Name, MochiReq) ->
%%   {mochiweb_request, MochiReqShort} = MochiReq,
...
%%     Req2 = {webmachine_request,ReqState2},
    {ok,ReqState3} = webmachine_request:send_response(Code, ReqState2),
%%     Req3 = {webmachine_request,ReqState3},
    {LogData,_ReqState4} = webmachine_request:log_data(ReqState3),
